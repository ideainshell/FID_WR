...
{ 	 				 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|GPIO_Pin_4|GPIO_Pin_8|GPIO_Pin_6|GPIO_Pin_7;
...
//	GPIO_Init(GPIOB, &GPIO_InitStructure);				    	 
	...
	GPIO_SetBits(GPIOE, GPIO_Pin_1|GPIO_Pin_3);
